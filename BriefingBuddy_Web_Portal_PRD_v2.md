...
### 13.1 Behavioural Source of Truth (Must Read)
Agents must treat the NOTAM categorisation + time-window behaviour defined in:

- `docs/BriefingBuddy_NOTAM_Logic_Agent_Digest.md`

…as the **authoritative behavioural reference** when implementing the web portal.

**Rule:** if a future implementation diverges from the Dart behaviour described in the digest, the **Dart logic wins** and the implementation must be adjusted to match.
